...
- <b>가시의 비극: 3막 타임라인</b>
     ...
     - 코토르노스 킥 시전 시 메인탱커는 첫 기둥 반대편으로 보스 유도
     - 보스 이동 후 힐러/원딜은 각자 기둥으로 이동<br>
       기둥으로 이동하는 타이밍에 전력 질주+견고한 마법/거리유지 사용
     - 보스가 이동하는 것을 본 뒤 ST와 D1, D2는 보스 타겟 범위 안쪽으로 들어간 다음<br>
       보스 기준 12 / 3 / 9시 위치에 서서 퀘이크 유도. (퀘이크 유도 시 거리유지 사용할 것)<br>
       <b>※코토르노스 퀘이크는 보스 기준 가장 가까운 대상 3인에게 유도됨※</b>
     - 퀘이크 피격 후 기둥을 처리한 힐러/딜러는 반대편 기둥으로 이동
     - 워터쟈가 발동하면서 파티원 전원 약한 넉백(중앙 기준 맵 절반 정도 넉백, 거리유지/견고한 마법 사용 시 무효화 가능)
     - 메인 탱커가 코토르노스 킥을 중앙으로 유도
     - 힐러/원딜이 두번째 기둥 처리, ST/D1/D2 퀘이크 유도 진행
     - 메인 탱커는 킥 유도 이후 확실하게 빠져서 퀘이크가 본진 및 본인에게 유도되지 않도록 주의할 것<br>
       칼끝딜이 가능하며, 퀘이크 유도하는 조가 보스 원형 범위 안으로 확실히 들어가서 유도해야함
- 코토르노스 킥
