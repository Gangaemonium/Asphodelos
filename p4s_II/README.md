...
- 가시의 비극: 2막 타임라인
    ...
    - 파이가, 에어로가가 부여된 인원들은 중앙에 모여서 다크 디자인을 한곳에 유도
    ...
    - 마지막 파이가 처리 후 궁극 충격 캐스팅이 완료되기 전에 중앙으로 모여서 체력 회복받을 것
- 가시의 비극: 제 3막
...
- 가시의 비극: 3막 타임라인
    ...
    - 코토르노스 킥 시전 시 MT는 첫번째 줄이 연결된 기둥 반대편으로 보스 유도
    - 보스 이동 후 힐러/원딜은 각자 기둥으로 이동<br>
    기둥으로 이동하는 타이밍에 전력 질주+견고한 마법/거리 유지 사용
    - 보스가 이동하는 것을 본 뒤 ST와 D1, D2는 보스 타겟 범위 안쪽으로 들어간 다음<br>
    보스 머리 방향 기준 12시 / 3시 / 9시 위치에 서서 퀘이크 유도. (퀘이크 유도 시 거리유지 사용할 것)<br>
    <b>※코토르노스 퀘이크는 보스 기준 가장 가까운 대상 3인에게 유도됨※</b>
    - 기둥 처리 직후 후 기둥조는 바로 반대편 기둥으로 이동
    - 워터쟈가 발동하면서 파티원 전원 약한 넉백(중앙 기준 맵 절반 정도 넉백, 거리 유지/견고한 마법 사용 시 넉백 방지 가능)
    - MT가 두번째 코토르노스 킥을 중앙으로 유도
    - 힐러/원딜은 두번째 기둥 처리, ST/D1/D2 퀘이크 유도 진행
    - MT는 킥 유도 이후 확실하게 빠져서 퀘이크가 본진 및 본인에게 유도되지 않도록 주의할 것<br>
    퀘이크 유도하는 조가 보스 원형 범위 안으로 확실하게 들어가서 유도할 경우 MT는 6시에서 칼끝딜 가능
- 코토르노스 킥
