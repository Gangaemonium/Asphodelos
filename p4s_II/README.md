...
- <b>가시의 비극: 2막 타임라인</b>
    ...
    - 파이가, 에어로가가 부여된 인원들은 중앙에 모여서 장판 설치
    - 첫 안전지대 확인 후 다음과 같이 이동<br>
      다쟈/파이가 탱커, 에어로가 딜러 : 북 or 서<br>
      다쟈/파이가 힐러, 딜러 : 남 or 동
    ...
    - 파이가 딜러는 D4321순서로 반시계 방향으로 이동하여 쉐어 처리<br>
      (예시 : D3, D4가 파이가 대상일 경우 D4가 반시계 방향으로 이동)
...
- <b>가시의 비극: 3막 타임라인</b>
     ...
     - MT는 킥 유도 이후 확실하게 빠져서 퀘이크가 본진 및 본인에게 유도되지 않도록 주의할 것<br>
       퀘이크 유도하는 조가 보스 원형 범위 안으로 확실하게 들어가서 유도해야할 경우 MT는 6시에서 칼끝딜 가능
- 코토르노스 킥
